...
public class SkillTreeUI : MonoBehaviour , IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    {
        // แทนที่จะใช้ skillBook ที่หามามั่วๆ ให้หาจาก Local Player ของเราจริงๆ
        SkillBook localSkillBook = NetworkManager.Singleton.LocalClient.PlayerObject.GetComponent<SkillBook>();
        SkillTreeManager.instance.Unlock(skill, localSkillBook);
    }
